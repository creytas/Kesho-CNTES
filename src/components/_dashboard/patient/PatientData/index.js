        ...
        <Grid item xs={11} sm={5} md={5}>
          ...
          >
            ...
            <InputLabel>
              ...
              <span style={{ color: "black" }}>
                {" "}
                {CauseMalnutrition.AtcdRougeole}{" "}
              </span>
            </InputLabel>
            <InputLabel>
              Nombre de chute :
        ...
        <Grid item xs={11} sm={7} md={7}>
          ...
          >
            ...
            <InputLabel>
              Mère enceint :
              <span style={{ color: "black" }}>{`${
                FamalyData.mereEnceinte ? "Non" : "Oui"
              }`}</span>
            </InputLabel>
            <InputLabel>
              Contraception mère :
